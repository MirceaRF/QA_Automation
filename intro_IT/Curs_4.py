...
for k, v in departamente.items():
    print((v.keys()), sep=",",end=" ")
    print()
#de ce nu imi printa si separatorii si endline ul
#pentru ca alea sunt valabile atunci cand avem mai multe valori de printat in aceeeasi instructiune de print
#dar la noi la fiecare print vom printa un singur departament, si atunci avand in vedere ca fiecare valoare se printeaza in alta iteratie
...
#Uitati-va peste ele, incercati sa le intelegeti, si daca e ceva neclar ma anuntati 🙂