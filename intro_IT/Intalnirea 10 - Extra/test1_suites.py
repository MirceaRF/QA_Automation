...
from Automation10_Projects.Python_Automation.P2_Introduction_to_Selenium.P2_selenium_automation.curs_10.test3_alerts import \
    Alerts
from Automation10_Projects.Python_Automation.P2_Introduction_to_Selenium.P2_selenium_automation.curs_10.test4_auth import \
    Authentication
from Automation10_Projects.Python_Automation.P2_Introduction_to_Selenium.P2_selenium_automation.curs_10.test5_context_menu import \
    ContextMenu
from Automation10_Projects.Python_Automation.P2_Introduction_to_Selenium.P2_selenium_automation.curs_10.test6_keys import \
    Keyboard
